...
namespace WindowsGSM.Plugins
{
    public class Satisfactory : SteamCMDAgent
    {
        ...
        public Plugin Plugin = new Plugin
        {
            ...
            version = "1.0",
            url = "https://github.com/chris007de/WindowsGSM.Satisfactory", // Github repository link (Best practice)
            color = "#ff9100" // Color Hex
        };
        ...
        // Documentation: https://satisfactory.fandom.com/wiki/Dedicated_servers
        // - Game server default values
		public string Port = "7777"; // Default port
		public string QueryPort = "15777";
		public string BeaconPort = "15000";
